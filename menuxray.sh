#!/bin/bash
# menuxray.sh - Versão Final: Instalação Automática na Opção 6
...
func_install_official_core() {
    ...
    echo "========================================="
    # Instala sempre (garante atualização e correção)
